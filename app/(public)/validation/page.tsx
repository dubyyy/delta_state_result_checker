  ...
  const handlePrintName = async () => {
    try {
      ...
      sortedRegs.forEach((student, index) => {
        ...
        // Full name
        const fullName = `${student.lastname.toUpperCase()}, ${student.firstname.toUpperCase()} ${(student.othername || "").toUpperCase()}`;
  ...
  const handlePrintCA = async () => {
    try {
      ...
      const drawTableHeader = () => {
        ...
        const fontSize = 6.5;
        const headers = [
          'SURNAME', 'FIRSTNAME', 'OTHERNAME', 'LGA', 'SCH', 'EXAM NO', 'SEX',
      ...
      sortedRegs.forEach((student, index) => {
        ...
        const rowData = [
          ...
          truncateText(student.firstname.toUpperCase(), colMiddleName - 4, 7),
          truncateText((student.othername || "").toUpperCase(), colFirstName - 4, 7),
          String(lgaIndex),
          schoolCode,
                  ...
                  <div>
                    {(() => {
                      const filteredRegistrations = registrations.filter((student) => {
                        ...
                        const fullName = `${student.lastname}, ${student.firstname} ${student.othername}`.toLowerCase();
                        return (
                ...
                {editFormData.passport && (
                  <div className="flex justify-center">
                    <img 
                      ...
                      alt={`${editFormData.lastname}, ${editFormData.firstname} ${editFormData.othername}`}
