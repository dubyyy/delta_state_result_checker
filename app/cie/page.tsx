...
export default function CIEStudentsPage() {
  ...
  const handleExportCSV = () => {
    const headers = ["Student Number", "Surname", "First Name", "Other Name", "Gender", "School", "Type", "Year", "Registration"];
          ...
          <div className="p-6">
            ...
            {editFormData && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label className="text-xs uppercase text-slate-500 tracking-wider font-bold">Other Name</Label>
                  <Input
